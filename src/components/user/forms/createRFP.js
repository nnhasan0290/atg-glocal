  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className='form-group'>
        <label htmlFor='eventTitle'>RFP Title</label>
        <input
          className={
      ...
      <div className='form-group'>
        <label htmlFor='description'>RFP Description</label>
        <Controller
          name='description'
          control={control}
          rules={{ required: true }}
...
export default connect(mapStateToProps)(CreateRFP);
